...
public final class KeyboardUtil {
     ...
     */
    public static void hideSoftInput(final Context context, @NonNull final Window window) {
     ...
     * @param window The window.
     */
    public static void fixSoftInputLeaks(final Context context, @NonNull final Window window) {
        InputMethodManager imm =
                (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
