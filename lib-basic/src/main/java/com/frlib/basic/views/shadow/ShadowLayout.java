package com.frlib.basic.views.shadow;
...
public class ShadowLayout extends FrameLayout {
    ...
    public void setShadowLimit(int mShadowLimit) {
        if (isShowShadow) {
            int dip5 = UIUtil.dp2px(getContext(), 5f);
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius, UIUtil.dp2px(getContext(), 0));
            ...
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_hl_shadowColor, ResourcesExtKt.color(getContext(), R.color.color_default_shadow));
            ...
            //背景颜色的点击(默认颜色为白色)
            mBackGroundColor = ResourcesExtKt.color(getContext(), R.color.color_white);
