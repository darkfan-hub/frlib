...
public class FrToasty2 {
    ...
    public static class Config {
        private Typeface typeface = FrToasty2.currentTypeface;
        private int textSize = FrToasty2.textSize;

        private boolean tintIcon = FrToasty2.tintIcon;
        ...
        public static void reset() {
            FrToasty2.currentTypeface = LOADED_TOAST_TYPEFACE;
            FrToasty2.textSize = 16;
            FrToasty2.tintIcon = true;
            FrToasty2.allowQueue = true;
        }
        ...
        public void apply() {
            FrToasty2.currentTypeface = typeface;
            FrToasty2.textSize = textSize;
            FrToasty2.tintIcon = tintIcon;
            FrToasty2.allowQueue = allowQueue;
        }
    }
}
