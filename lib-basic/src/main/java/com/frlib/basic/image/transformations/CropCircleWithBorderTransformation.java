...
import com.frlib.basic.image.internal.Utils;
...
public class CropCircleWithBorderTransformation extends BitmapTransformation {
    ...
    private static final String ID = "com.juliye.library.image.transformations.CropCircleWithBorderTransformation." + VERSION;
