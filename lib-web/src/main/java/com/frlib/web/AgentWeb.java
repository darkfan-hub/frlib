...
public final class AgentWeb {
     ...
     * WebChromeClient
     */
    private com.frlib.web.WebChromeClient mWebChromeClient;
    /**
     * WebViewClient
     */
    private com.frlib.web.WebViewClient mWebViewClient;
    /**
     * is show indicator
     */
    ...
    public AgentWeb clearWebCache() {
        if (this.getWebCreator().getWebView() != null) {
            AgentWebUtil.clearWebViewAllCache(mActivity, this.getWebCreator().getWebView());
        } else {
            AgentWebUtil.clearWebViewAllCache(mActivity);
        }
        return this;
    }
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder setWebChromeClient(@Nullable com.frlib.web.WebChromeClient webChromeClient) {
            this.mAgentBuilder.mWebChromeClient = webChromeClient;
            return this;
        }

        public CommonBuilder setWebViewClient(@Nullable com.frlib.web.WebViewClient webChromeClient) {
