...
public class DefaultUIController extends AbsAgentWebUIController {
    ...
    public void onJsAlert(WebView view, String url, String message) {
        AgentWebUtil.toastShowShort(view.getContext().getApplicationContext(), message);
    }
    ...
    public void onOpenPagePrompt(WebView view, String url, final Handler.Callback callback) {
        ...
        if (mAskOpenOtherAppDialog == null) {
            mAskOpenOtherAppDialog = new AlertDialog
                    .Builder(mActivity)
                    .setMessage(mResources.getString(R.string.web_text_leave_app_and_go_other_page,
                            AgentWebUtil.getApplicationName(mActivity)))
                    .setTitle(mResources.getString(R.string.web_text_tips))
                    ...
                    .setPositiveButton(mResources.getString(R.string.web_text_leave), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            if (callback != null) {
                                callback.handleMessage(Message.obtain(null, 1));
    ...
    private void onForceDownloadAlertInternal(final Handler.Callback callback) {
        ...
        mAlertDialog = new AlertDialog.Builder(mActivity)
                .setTitle(mResources.getString(R.string.web_text_tips))
                .setMessage(mResources.getString(R.string.web_text_honeycomblow))
                .setNegativeButton(mResources.getString(R.string.web_text_download), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (dialog != null) {
                            dialog.dismiss();
                ...
                .setPositiveButton(mResources.getString(R.string.web_text_cancel), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void onShowMessage(String message, String from) {
        ...
        AgentWebUtil.toastShowShort(mActivity.getApplicationContext(), message);
    }
