...
import com.frlib.picker.wheel.adapter.WheelAdapter;
import com.frlib.picker.wheel.interfaces.IPickerViewData;
import com.frlib.picker.wheel.listener.LoopViewGestureListener;
import com.frlib.picker.wheel.listener.OnItemSelectedListener;
import com.frlib.picker.wheel.timer.InertiaTimerTask;
import com.frlib.picker.wheel.timer.MessageHandler;
import com.frlib.picker.wheel.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = ConvertUtil.sp2px(context, 17f);//默认大小
    ...
    public final void setCenterTypeface(Typeface font) {
        paintCenterText.setTypeface(typeface);
    }

    public final void setOuterTypeface(Typeface font) {
        paintOuterText.setTypeface(typeface);
    }
    ...
    public final void setCenterTextSize(int size) {
        paintCenterText.setTextSize(size);
    }

    public final void setOuterTextSize(int size) {
