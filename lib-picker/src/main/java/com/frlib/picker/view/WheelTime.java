package com.frlib.picker.view;

import android.view.View;
import com.frlib.picker.R;
import com.frlib.picker.adapter.ArrayWheelAdapter;
import com.frlib.picker.adapter.NumericWheelAdapter;
import com.frlib.picker.listener.ISelectTimeCallback;
import com.frlib.picker.utils.ChinaDate;
import com.frlib.picker.utils.LunarCalendar;
import com.frlib.picker.view.WheelView;
import com.frlib.picker.wheel.listener.OnItemSelectedListener;
...
//                maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_year != null) {
            ...
            wv_year.setLabel(view.getContext().getString(R.string.picker_text_year));
        }
        if (label_month != null) {
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string.picker_text_month));
        }
        if (label_day != null) {
            wv_day.setLabel(label_day);
        } else {
            wv_day.setLabel(view.getContext().getString(R.string.picker_text_day));
        }
        if (label_hours != null) {
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string.picker_text_hours));
        }
        if (label_mins != null) {
            wv_minutes.setLabel(label_mins);
        } else {
            wv_minutes.setLabel(view.getContext().getString(R.string.picker_text_minutes));
        }
        if (label_seconds != null) {
            wv_seconds.setLabel(label_seconds);
        } else {
            wv_seconds.setLabel(view.getContext().getString(R.string.picker_text_seconds));
        }
