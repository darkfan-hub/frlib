package com.frlib.picker.configure;
...
import com.frlib.picker.listener.*;
...
public class PickerOptions {
    ...
    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.picker_layout_options;
        } else {
            layoutRes = R.layout.picker_layout_time;
        }
    }
}
